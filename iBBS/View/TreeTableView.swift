...
//    func cellClick(_: String) //参数还没加，TreeNode表示节点
    func cellClick(treeNode: TreeNode)
//    func cellClick(treeTableView: TreeTableView, treeNode: TreeNode)
}
...
//            let vc: NewSectionController = NewSectionController()
//            let naviController = UINavigationController(rootViewController: vc)
//            let storyboard = UIStoryboard(name: "Main", bundle: nil)
//            let board = storyboard.instantiateViewControllerWithIdentifier("board") as! BoardController
//            board.board_name = parentNode.name!
//            self.window!.rootViewController = naviController
//            naviController.pushViewController(board, animated: true)
            treeTableViewCellDelegate?.cellClick(parentNode)
